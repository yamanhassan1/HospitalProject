...
void createDoctor(Doctor*& doctor) {
    ...
    doctor = new Doctor(id, name, age, gender, address, contact, salary, department, joinDate, specialization, license);
}
...
void createNurse(Nurse*& nurse) {
    ...
    nurse = new Nurse(id, name, age, gender, address, contact, salary, department, joinDate, shift, qualification);
}
